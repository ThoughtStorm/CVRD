    ...
    var clazz = declare([BaseWidget, PoolControllerMixin], {
      ...
      postCreate: function() {
        ...
        if (this.appConfig && this.appConfig.logo) {
          this.logoNode.src = window.path+this.appConfig.logo;
      ...
      _setElementsSize: function() {
		...
		html.setStyle(this.backLinkNode, {
          lineHeight: this.height + 'px'
        });
      ...
      _createPopupLinkNode: function() {
        ...
        var logoNode = html.create('img', {
          ...
          src: this.appConfig.logo ? window.path+this.appConfig.logo : this.folderUrl + 'images/app-logo.png',
          style: {
            width: '30px',
            height: '30px',
            marginTop: ((this.height - 30) / 2) + 'px'
