  ...
  return declare([_WidgetBase, Evented], {
    ...
    **/
    _getGeocoders: function () {
      ...
      defaultSources = [];
      if (this.config.helperServices && this.config.helperServices.geocode !== null) {
    ...
    _getSearchLayers: function () {
      ...
      if (this.config.response.itemInfo.itemData && this.config.response
        ...
        array.forEach(searchOptions.layers, lang.hitch(this, function (searchLayer) {
          var operationalLayers, layer, source, url, name, popupInfo, subLayerInfo,
          ...
          if (layer && layer.hasOwnProperty("url")) {
            if (layer.layerObject) {
              ...
              if (esriLang.isDefined(searchLayer.subLayer)) {
                ...
                subLayerInfo = this._getSubLayerInfo(layer, searchLayer.subLayer);
              ...
              if (popupInfo) {
                source.infoTemplate = new PopupTemplate(popupInfo);
              }
    ...
    _getSubLayerInfo: function (opLayer, layerId) {
      ...
      array.some(opLayer.layers, lang.hitch(this, function (subLayer) {
        if (subLayer.id === parseInt(layerId, 10)) {
          ...
          if (subLayer.layerDefinition && subLayer.layerDefinition.definitionExpression) {
            subLayerInfo.definitionExpression = subLayer.layerDefinition.definitionExpression;
          }
        }
      }));
      return subLayerInfo;
